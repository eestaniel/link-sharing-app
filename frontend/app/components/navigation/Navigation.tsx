...
const Navigation = () => {
  ...
  const logo = useMemo(() => {
    ...
    if (!path.includes('/dashboard/')) {
      return <svg xmlns="http://www.w3.org/2000/svg" width="183" height="40" fill="none" viewBox="0 0 183 40">
      ...
      return (
        <>
          ...
          <div className={styles.link_group}>
            <div className={`${styles.icon_container} ${currentPage === 'edit-links' ? styles.active : ''}`}
                 onClick={() => handlePageChange('edit-links')}>
              <svg className={styles.svg_img} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"
                   viewBox="0 0 16 16">
                <path fill=""
            ...
            <div className={`${styles.icon_container} ${currentPage === 'edit-profile' ? styles.active : ''}`}
                 onClick={() => handlePageChange('edit-profile')}>
              <svg className={styles.svg_img} xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none"
                   viewBox="0 0 21 20">
                <path fill=""
          ...
          <div className={styles.preview_icon_container} onClick={() => handlePageChange('preview-links')}>
