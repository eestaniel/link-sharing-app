...
const Navigation = () => {
  const { sessionId, currentPage, setCurrentPage } = useLinksStore(state => ({
  ...
  const logo = useMemo(() => {
    if (!sessionId) {
      return <img src="app/assets/images/logo-devlinks-large.svg" alt="DevLinks Large Logo" />;
    } else {
      return (
          <>
            <img src="app/assets/images/logo-devlinks-small.svg" alt="DevLinks Small Logo" />
            <div className={styles.link_group}>
              <div className={`${styles.icon_container} ${currentPage === 'page1' ? styles.active : ''}`} onClick={() => handlePageChange('page1')}>
                <svg className={styles.svg_img} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16">
              ...
              <div className={`${styles.icon_container} ${currentPage === 'page2' ? styles.active : ''}`} onClick={() => handlePageChange('page2')}>
                <svg className={styles.svg_img} xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
            ...
            <div className={styles.preview_icon_container} onClick={() => handlePageChange('page3')}>
  ...
  }, [sessionId, currentPage, handlePageChange]);
