import styles from "~/styles/dashboard.links.module.css"


export const EmptyLinksIcon = () => {
  return (
    <svg className={styles.empty_icons}
         xmlns="http://www.w3.org/2000/svg" width="250" height="161"
         fill="none"
         viewBox="0 0 250 161">
      <path fill="#fff"
